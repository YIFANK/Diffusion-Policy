...
from network import ConditionalUnet1D, SinusoidalPosEmb, Downsample1d, Upsample1d, Conv1dBlock, ConditionalResidualBlock1D
...
#save the model
torch.save(ema_nets.state_dict(), '../output/diffusion_policy.pth')